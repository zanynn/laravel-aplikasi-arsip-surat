...
<div id="content" class="app-content">
	...
	<div class="row">
		<div class="card">
			<div class="card-header fw-bold small">Buat Surat</div>
			<div class="card-body">
				<h5 class="card-title">Arsip Surat</h5>
				<h6 class="card-subtitle mb-3 text-white text-opacity-50">Unggah surat yang telah terbit pada form ini untuk diarsipkan</h6>
			...
			<div class="card-body">
				...
				<form class="text-left p-3" action="{{route('arsip.store')}}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group mb-3">
						...
						<input type="text" class="form-control" id="exampleFormControlInput1" name="nomor" placeholder="XII" required>
					</div>
					<div class="form-group mb-3">
					...
					<div class="form-group mb-3">
						...
						<input type="text" class="form-control" id="exampleFormControlInput1" name="judul" placeholder="Judul" required>
					</div>
					<!-- file input -->
					<div class="form-group mb-3">
					...
					<h6 class="card-subtitle mb-3 text-white text-opacity-50">Gunakan file berformat PDF</h6>
